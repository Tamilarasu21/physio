      ...
      <div class="col-xl-3 col-lg-6">
        <div class="card card-inverse card-warning m-1">
          <div class="card-block bg-warning p-2">
            ...
            <h6 class="text-uppercase text-light">Admins</h6>
            <h1 class="display-1 text-light">
            <?php
                $adm_l = mysqli_query($con, "select * from appoinment");
                $c_adm = mysqli_num_rows($adm_l);
                echo $c_adm;
                ?>
            </h1>
          </div>
    ...
    <div class="row justify-content-center">
      <div class="col-md-3">
        <div class="card bg-primary text-center">
          <a href="add_admin.php" class="text-light text-decoration-none">Add Admin</a>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card bg-success text-center">
          <a href="add_doctor.php" class="text-light text-decoration-none">Add Doctor</a>
        </div>
      </div>
    </div>
  </div>
